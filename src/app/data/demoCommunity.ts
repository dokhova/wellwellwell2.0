...
export const demoCommunity = {
  people: [
    { id: "demo-01", name: "Андрей Соколов", avatar: "avatar_10.png", isDemo: true, tags: ["Бег"], bio: "Пишу код и бегаю по утрам — до первого созвона успеваю 5 км. Цель на осень — первая официальная десятка.", plan: { id: "demo-plan-01", series: "Long Run", title: "Субботний Long Run", description: "Каждую субботу выходим на длинную спокойную пробежку. После финиша делимся фотографиями, маршрутом и скриншотами из Strava.", cover: "cover_10.png", schedule: "Суббота, 09:00", location: "Онлайн", participantsCount: 5, participantIds: ["demo-02", "demo-03", "demo-06", "demo-11", "demo-12"] } },
    { id: "demo-02", name: "Ирина Морозова", avatar: "avatar_11.png", isDemo: true, tags: ["Бег"], bio: "Начала бегать этой весной и неожиданно втянулась. Лучшая часть дня — пробежка, пока город ещё спит.", plan: { id: "demo-plan-02", series: "Доброе беговое утро", title: "Доброе беговое утро", description: "Если успел выйти на пробежку до начала рабочего дня — присоединяйся. Показываем рассветы и делимся настроением.", cover: "cover_11.png", schedule: "Понедельник, 07:30", location: "Онлайн", participantsCount: 4, participantIds: ["demo-03", "demo-04", "demo-05", "demo-10"] } },
    ...
    { id: "demo-05", name: "Максим Романов", avatar: "avatar_14.png", isDemo: true, tags: ["Бег"], bio: "Начал бегать в 35 и жалею только об одном — что не начал раньше. Инженер, люблю цифры и видимый прогресс.", plan: { id: "demo-plan-05", series: "Цель недели", title: "Цель на неделю", description: "Каждое воскресенье ставим небольшую цель на следующую неделю и поддерживаем друг друга.", cover: "cover_14.png", schedule: "Воскресенье, 20:00", location: "Онлайн", participantsCount: 5, participantIds: ["demo-01", "demo-04", "demo-07", "demo-10", "demo-11"] } },
    { id: "demo-06", name: "Дарья Николаева", avatar: "avatar_15.png", isDemo: true, tags: ["Бег"], bio: "Готовлюсь к своим первым 10 км. Волнуюсь, но именно поэтому здесь — вместе не так страшно.", plan: { id: "demo-plan-06", series: "Первый старт", title: "Первый старт", description: "Если готовишься к своему первому забегу — присоединяйся. Делимся подготовкой и переживаниями.", cover: "cover_15.png", schedule: "Пятница, 18:30", location: "Онлайн", participantsCount: 4, participantIds: ["demo-04", "demo-08", "demo-10", "demo-12"] } },
    ...
    { id: "demo-08", name: "Ольга Фролова", avatar: "avatar_17.png", isDemo: true, tags: ["Бег"], bio: "Возвращаюсь к бегу после рождения сына. Пока три километра, но каждая пробежка — маленькая победа.", plan: { id: "demo-plan-08", series: "Маленькие победы", title: "Маленькая победа недели", description: "Делимся любым прогрессом: первая пробежка, новый маршрут или просто удалось выйти из дома.", cover: "cover_17.png", schedule: "Воскресенье, 19:00", location: "Онлайн", participantsCount: 5, participantIds: ["demo-01", "demo-03", "demo-06", "demo-07", "demo-11"] } },
    { id: "demo-09", name: "Никита Крылов", avatar: "avatar_18.png", isDemo: true, tags: ["Бег"], bio: "Аналитик. Бег — моя ежедневная дисциплина: план тренировок, пульсовые зоны и никаких оправданий.", plan: { id: "demo-plan-09", series: "Интервалы", title: "Интервальный вторник", description: "Выполняем интервальную тренировку в своём темпе, а после делимся результатами и ощущениями.", cover: "cover_18.png", schedule: "Вторник, 19:00", location: "Онлайн", participantsCount: 4, participantIds: ["demo-02", "demo-03", "demo-04", "demo-06"] } },
