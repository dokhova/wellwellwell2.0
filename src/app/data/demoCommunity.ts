import avatar10 from "@/imports/avatar_10-opt.jpg";
import avatar11 from "@/imports/avatar_11-opt.jpg";
import avatar12 from "@/imports/avatar_12-opt.jpg";
import avatar13 from "@/imports/avatar_13-opt.jpg";
import avatar14 from "@/imports/avatar_14-opt.jpg";
import avatar15 from "@/imports/avatar_15-opt.jpg";
import avatar16 from "@/imports/avatar_16-opt.jpg";
import avatar17 from "@/imports/avatar_17-opt.jpg";
import avatar18 from "@/imports/avatar_18-opt.jpg";
import avatar19 from "@/imports/avatar_19-opt.jpg";
import avatar20 from "@/imports/avatar_20-opt.jpg";
import avatar21 from "@/imports/avatar_21-opt.jpg";
import cover10 from "@/imports/cover_10-opt.jpg";
import cover11 from "@/imports/cover_11-opt.jpg";
import cover12 from "@/imports/cover_12-opt.jpg";
import cover13 from "@/imports/cover_13-opt.jpg";
import cover14 from "@/imports/cover_14-opt.jpg";
import cover15 from "@/imports/cover_15-opt.jpg";
import cover16 from "@/imports/cover_16-opt.jpg";
import cover17 from "@/imports/cover_17-opt.jpg";
import cover18 from "@/imports/cover_18-opt.jpg";
import cover19 from "@/imports/cover_19-opt.jpg";
import cover20 from "@/imports/cover_20-opt.jpg";
import cover21 from "@/imports/cover_21-opt.jpg";
...
export const demoCommunity = {
  people: [
    ...
    { id: "demo-02", name: "Ирина Морозова", avatar: "avatar_11.png", isDemo: true, tags: ["Бег"], bio: "Маркетолог из Москвы. Начала бегать этой весной и любит утренние пробежки.", plan: { id: "demo-plan-02", series: "Доброе беговое утро", title: "Доброе беговое утро", description: "Если успел выйти на пробежку до начала рабочего дня — присоединяйся. Показываем рассветы и делимся настроением.", cover: "cover_11.png", schedule: "Понедельник, 07:30", location: "Онлайн", participantsCount: 4, participantIds: ["demo-03", "demo-04", "demo-05", "demo-10"] } },
    { id: "demo-03", name: "Егор Лебедев", avatar: "avatar_12.png", isDemo: true, tags: ["Бег"], bio: "Фотограф из Москвы. Любит красивые маршруты и трейлы.", plan: { id: "demo-plan-03", series: "Фото недели", title: "Фото недели", description: "Делимся самым красивым кадром с пробежки этой недели. Не важно, парк это, набережная или лес.", cover: "cover_12.png", schedule: "Четверг, 20:00", location: "Онлайн", participantsCount: 5, participantIds: ["demo-01", "demo-08", "demo-09", "demo-10", "demo-11"] } },
    { id: "demo-04", name: "Анна Волкова", avatar: "avatar_13.png", isDemo: true, tags: ["Бег"], bio: "Дизайнер из Москвы. Бегает вечером после работы.", plan: { id: "demo-plan-04", series: "Вечерняя пробежка", title: "Вечерний лёгкий бег", description: "Спокойная восстановительная пробежка после рабочего дня. После делимся впечатлениями и маршрутами.", cover: "cover_13.png", schedule: "Среда, 19:30", location: "Онлайн", participantsCount: 3, participantIds: ["demo-05", "demo-10", "demo-12"] } },
    { id: "demo-05", name: "Максим Романов", avatar: "avatar_14.png", isDemo: true, tags: ["Бег"], bio: "Инженер из Москвы. Начал бегать после 35 лет.", plan: { id: "demo-plan-05", series: "Цель недели", title: "Цель на неделю", description: "Каждое воскресенье ставим небольшую цель на следующую неделю и поддерживаем друг друга.", cover: "cover_14.png", schedule: "Воскресенье, 20:00", location: "Онлайн", participantsCount: 5, participantIds: ["demo-01", "demo-04", "demo-07", "demo-10", "demo-11"] } },
    { id: "demo-06", name: "Дарья Николаева", avatar: "avatar_15.png", isDemo: true, tags: ["Бег"], bio: "Студентка из Москвы. Готовится к первым официальным 10 км.", plan: { id: "demo-plan-06", series: "Первый старт", title: "Первый старт", description: "Если готовишься к своему первому забегу — присоединяйся. Делимся подготовкой и переживаниями.", cover: "cover_15.png", schedule: "Пятница, 18:30", location: "Онлайн", participantsCount: 4, participantIds: ["demo-04", "demo-08", "demo-10", "demo-12"] } },
    ...
    { id: "demo-08", name: "Ольга Фролова", avatar: "avatar_17.png", isDemo: true, tags: ["Бег"], bio: "Молодая мама из Москвы. Возвращается к бегу после рождения ребёнка.", plan: { id: "demo-plan-08", series: "Маленькие победы", title: "Маленькая победа недели", description: "Делимся любым прогрессом: первая пробежка, новый маршрут или просто удалось выйти из дома.", cover: "cover_17.png", schedule: "Воскресенье, 19:00", location: "Онлайн", participantsCount: 5, participantIds: ["demo-01", "demo-03", "demo-06", "demo-07", "demo-11"] } },
    { id: "demo-09", name: "Никита Крылов", avatar: "avatar_18.png", isDemo: true, tags: ["Бег"], bio: "Аналитик из Москвы. Бегает ради здоровья и дисциплины.", plan: { id: "demo-plan-09", series: "Интервалы", title: "Интервальный вторник", description: "Выполняем интервальную тренировку в своём темпе, а после делимся результатами и ощущениями.", cover: "cover_18.png", schedule: "Вторник, 19:00", location: "Онлайн", participantsCount: 4, participantIds: ["demo-02", "demo-03", "demo-04", "demo-06"] } },
    { id: "demo-10", name: "София Орлова", avatar: "avatar_19.png", isDemo: true, tags: ["Бег"], bio: "Копирайтер из Москвы. Любит бегать вдоль моря.", plan: { id: "demo-plan-10", series: "Музыка для бега", title: "Что сегодня в наушниках?", description: "Делимся любимыми плейлистами, подкастами и треками для пробежек.", cover: "cover_19.png", schedule: "Пятница, 18:00", location: "Онлайн", participantsCount: 5, participantIds: ["demo-02", "demo-06", "demo-07", "demo-11", "demo-12"] } },
    { id: "demo-11", name: "Кирилл Власов", avatar: "avatar_20.png", isDemo: true, tags: ["Бег"], bio: "UX-дизайнер из Москвы. Исследует город через бег.", plan: { id: "demo-plan-11", series: "Новый маршрут", title: "Маршрут недели", description: "Показываем интересные маршруты, которые открыли для себя на этой неделе.", cover: "cover_20.png", schedule: "Четверг, 19:00", location: "Онлайн", participantsCount: 4, participantIds: ["demo-01", "demo-05", "demo-06", "demo-10"] } },
    { id: "demo-12", name: "Алина Сергеева", avatar: "avatar_21.png", isDemo: true, tags: ["Бег"], bio: "Иллюстратор из Москвы. Бегает ради удовольствия без гонки за временем.", plan: { id: "demo-plan-12", series: "Восстановление", title: "Восстановительная среда", description: "После тренировки уделяем время растяжке, прогулке или роллу и рассказываем, что помогает восстановиться.", cover: "cover_21.png", schedule: "Среда, 20:30", location: "Онлайн", participantsCount: 3, participantIds: ["demo-02", "demo-08", "demo-09"] } },
  ],
} as const;
